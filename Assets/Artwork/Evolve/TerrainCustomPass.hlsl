#ifndef UNIVERSAL_TERRAIN_LIT_PASSES_ADD_INCLUDED
#define UNIVERSAL_TERRAIN_LIT_PASSES_ADD_INCLUDED
...
#endif
{
    ...
    */
    ...
    //stepなので0か1
    float scanline = step(
        distance(IN.positionWS.xyz, _PlayerPos.xyz),
        _AreaSize
    );
    ...
    if (scanline > 0.5f)
    {
        color.rgb = color.rgb + _AreaColor * scanline;
    }
    else
    {
        color.rgb = color.rgb + _EdgeColor * edge;
    }
    //ここまで
